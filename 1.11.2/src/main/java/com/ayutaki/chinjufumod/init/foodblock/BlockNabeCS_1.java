...
public class BlockNabeCS_1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != TTimeItems.Item_SARA) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.NABECORNS_1
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CORNSOUP_1)));
			}
