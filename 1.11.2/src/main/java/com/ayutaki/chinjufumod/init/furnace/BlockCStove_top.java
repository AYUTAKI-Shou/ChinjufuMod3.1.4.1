...
public class BlockCStove_top extends BlockContainer {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(New_ChinjufuModSchool.CSTOVE_top);
    }
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else if (worldIn.getBlockState(new BlockPos(i, j - 1, k)).getBlock() == New_ChinjufuModSchool.CSTOVE_bot) {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, New_ChinjufuModSchool.LIT_CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, New_ChinjufuModSchool.LIT_CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, New_ChinjufuModSchool.CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, New_ChinjufuModSchool.CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(New_ChinjufuModSchool.CSTOVE_top);
    }
