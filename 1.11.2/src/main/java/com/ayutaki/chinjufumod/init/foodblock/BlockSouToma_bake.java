...
public class BlockSouToma_bake extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != TTimeItems.PASTA_sara) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.TOMATOSAU_bake
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.PASTATOMA_1)));
			}
