...
public class BlockCurryNabe_1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != Item.getItemFromBlock(ChinjufuModFoodBlocks.RICE_1)) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.CURRYNABE_1
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CURRY_1)));
			}
