...
public class BlockTaru_Budoushu_1 extends BlockRotatedPillar {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side,
		...
		if (item != TTimeItems.Item_SAKEBOTTLE) {
			...
			return worldIn.setBlockState(pos,ASDecoModHakkou.BUDOUSHUTARU_1
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.WINEBOT_1)));
			}
