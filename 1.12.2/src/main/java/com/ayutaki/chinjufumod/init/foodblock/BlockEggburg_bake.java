...
public class BlockEggburg_bake extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != TTimeItems.Item_SARA) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.EGGBURG_bake
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.EGGBURG_1)));
			}
