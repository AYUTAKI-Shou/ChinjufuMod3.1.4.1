...
public class BlockNabe_1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != TTimeItems.Item_TONSUI) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.NABE_1
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.TONSUI_1)));
			}
