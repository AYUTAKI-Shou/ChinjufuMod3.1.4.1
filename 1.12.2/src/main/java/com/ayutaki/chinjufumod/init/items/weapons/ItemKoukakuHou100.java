    ...
    public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft)
    {
        if (entityLiving instanceof EntityPlayer)
        {
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                {
                    itemstack = new ItemStack(New_ChinjufuModWeapons.AMMUNITION_KC);
                }
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote)
                    {
                        ItemArrow itemarrow = (ItemArrow)(itemstack.getItem() instanceof ItemAmmunition_KC ? itemstack.getItem() : New_ChinjufuModWeapons.AMMUNITION_KC);
                    ...
                    worldIn.playSound((EntityPlayer)null, entityplayer.posX, entityplayer.posY, entityplayer.posZ, SoundEvents.ENTITY_GHAST_SHOOT, SoundCategory.PLAYERS, 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
