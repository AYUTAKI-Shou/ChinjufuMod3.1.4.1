...
public class BlockPastaNabe_bost extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (item != TTimeItems.Item_SARA) {
			...
			return worldIn.setBlockState(pos,ChinjufuModFoodBlocks.PASTANABE_bost
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
    	}
			...
			if (itemstack.isEmpty()) {
				playerIn.setHeldItem(hand, new ItemStack(TTimeItems.PASTA_sara));
			}
