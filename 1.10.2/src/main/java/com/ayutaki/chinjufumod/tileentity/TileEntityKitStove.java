...
public class TileEntityKitStove  extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.kitchen_stove";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockKitchen_stove.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
