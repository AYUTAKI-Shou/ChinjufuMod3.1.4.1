...
public class BlockKit_tcup2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!playerIn.capabilities.allowEdit) {
    		...
    		worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TCUP1.getDefaultState().withProperty(FACING, state.getValue(FACING)));
			...
			worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TCUP3
