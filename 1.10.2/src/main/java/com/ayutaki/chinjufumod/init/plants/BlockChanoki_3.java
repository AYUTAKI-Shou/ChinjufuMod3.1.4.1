	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity,
    	...
    	if (heldItem == null) {
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.addItemStackToInventory(new ItemStack(TTimeItems.TUMICHABA, 4));
				return world.setBlockState(pos, TTimePlants.CHANOKI_2.getDefaultState());
		}
