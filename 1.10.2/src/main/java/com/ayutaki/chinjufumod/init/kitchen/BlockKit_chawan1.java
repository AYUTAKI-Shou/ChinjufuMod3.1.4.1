...
public class BlockKit_chawan1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (heldItem == null) {
			...
			worldIn.setBlockState(pos, ASDecoModKitchen.KIT_CHAWAN2.getDefaultState()
					.withProperty(FACING, state.getValue(FACING)));
		}
		return true;
	}
