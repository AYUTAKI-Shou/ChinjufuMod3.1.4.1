...
import com.ayutaki.chinjufumod.entity.render.RenderingHandlerAmmunition_KC;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerEntityRender() {
		RenderingRegistry.registerEntityRenderingHandler(EntityAmmunition_KC.class, new RenderingHandlerAmmunition_KC());
