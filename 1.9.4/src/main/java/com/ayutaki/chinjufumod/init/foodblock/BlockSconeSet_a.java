	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity,
		...
		if (true) {
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.addItemStackToInventory(new ItemStack(ChinjufuModItemFoods.SCONE, 1));
		}

		return world.setBlockState(pos, ChinjufuModFoodBlocks.SCONESET_b.getDefaultState().withProperty(FACING, state.getValue(FACING)));
	}
