...
public class BlockKit_yunomi2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!playerIn.capabilities.allowEdit) {
    		...
    		worldIn.setBlockState(pos, ASDecoModKitchen.KIT_YUNOMI1.getDefaultState().withProperty(FACING, state.getValue(FACING)));
			...
			worldIn.setBlockState(pos, ASDecoModKitchen.KIT_YUNOMI3
