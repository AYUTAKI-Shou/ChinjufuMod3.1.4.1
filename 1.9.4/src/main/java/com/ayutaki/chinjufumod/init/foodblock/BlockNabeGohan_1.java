    	...
    	Item item = heldItem.getItem();
       	if (item == TTimeItems.Item_CHAWAN) {
    		...
    		if (playerIn instanceof EntityPlayer)
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.GOHAN_1), 1));

			worldIn.setBlockState(pos, ChinjufuModFoodBlocks.NABEGOHAN_2
    		...
    		if (playerIn instanceof EntityPlayer)
				((EntityPlayer) playerIn).inventory
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.RICE_1), 1));
			...
			if (playerIn instanceof EntityPlayer)
    			((EntityPlayer) playerIn).inventory.clearMatchingItems(Items.BOWL, -1, 1, null);
    		if (playerIn instanceof EntityPlayer)
				((EntityPlayer) playerIn).inventory
				.addItemStackToInventory(new ItemStack(TTimeItems.MUSHIGOME, 1));
