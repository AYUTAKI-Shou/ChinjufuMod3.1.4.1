    	...
    	Item item = heldItem.getItem();
       	if (item == TTimeItems.Item_TCUP) {
    		...
    		if (playerIn instanceof EntityPlayer)
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.TEACUP_1), 1));

			worldIn.setBlockState(pos, ChinjufuModFoodBlocks.TEAPOT_kara
