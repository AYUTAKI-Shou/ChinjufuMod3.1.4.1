    	...
    	Item item = heldItem.getItem();
       	if (item == TTimeItems.Item_DRINKGLASS) {
    		...
    		if (playerIn instanceof EntityPlayer)
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.JUKUCIDERGLA_1), 1));

			worldIn.setBlockState(pos, ASDecoModHakkou.JUKUCIDERBOT_kara
