	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity,
		...
		if (true) {
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.addItemStackToInventory(new ItemStack(ChinjufuModItemFoods.CHICKENSAND, 1));
		}

		return world.setBlockState(pos, ChinjufuModFoodBlocks.SCONESET_3.getDefaultState().withProperty(FACING, state.getValue(FACING)));
	}
