    	...
    	Item item = heldItem.getItem();
       	if (item == TTimeItems.Item_SARA) {
    		...
    		if (playerIn instanceof EntityPlayer)
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CORNSOUP_1), 1));

			worldIn.setBlockState(pos, ChinjufuModFoodBlocks.NABECORNS_4
