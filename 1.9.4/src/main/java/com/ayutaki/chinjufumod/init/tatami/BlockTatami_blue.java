...
public abstract class BlockTatami_blue extends BlockSlab {

	public static final PropertyInteger LOG = PropertyInteger.create("log", 1, 4);

	public BlockTatami_blue(String unlocalizedName) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModTatami.TATAMI_H_blue);
	}
