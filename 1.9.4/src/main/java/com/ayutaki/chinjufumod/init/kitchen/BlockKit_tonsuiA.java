...
public class BlockKit_tonsuiA extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!playerIn.capabilities.allowEdit) {
    		...
    		worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TONSUI4.getDefaultState().withProperty(FACING, state.getValue(FACING)));
			...
			worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TONSUIB
