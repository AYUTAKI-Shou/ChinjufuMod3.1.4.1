...
public class BlockKit_tonsui3 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!playerIn.capabilities.allowEdit) {
    		...
    		worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TONSUI2.getDefaultState().withProperty(FACING, state.getValue(FACING)));
			...
			worldIn.setBlockState(pos, ASDecoModKitchen.KIT_TONSUI4
