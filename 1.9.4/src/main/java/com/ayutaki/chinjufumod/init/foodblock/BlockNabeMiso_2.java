    	...
    	Item item = heldItem.getItem();
       	if (item == TTimeItems.Item_SHIKKI) {
    		...
    		if (playerIn instanceof EntityPlayer)
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.MISOSOUP_1), 1));

			worldIn.setBlockState(pos, ChinjufuModFoodBlocks.NABEMISO_3
